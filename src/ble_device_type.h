 ...
 */
//#define DEVICE_IS_BLE_SERVER 1 // Set to 1 to configure this build as a BLE server
...
// This also can work:
//#define SERVER_BT_ADDRESS (bd_addr) { .addr = { , , , , ,  } }
#define SERVER_BT_ADDRESS (bd_addr) { .addr = { 0x2c, 0x03, 0x92, 0x27, 0xfd, 0x84 }  }
